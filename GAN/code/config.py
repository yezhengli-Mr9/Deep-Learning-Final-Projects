...
data_arg.add_argument('--model_type', type=str, default='wgan', choices=['gan', 'lsgan', 'wgan'])

# Training / test parameters
train_arg = add_argument_group('Training')
train_arg.add_argument('--is_train', type=str2bool, default=True)
train_arg.add_argument('--optimizer', type=str, default='adam')
train_arg.add_argument('--max_step', type=int, default=4000)
train_arg.add_argument('--img_save_step', type=int, default=125)
train_arg.add_argument('--epoch_step', type=int, default=200)
...
misc_arg.add_argument('--log_step', type=int, default=125)
misc_arg.add_argument('--test_iter', type=int, default=4000)
misc_arg.add_argument('--save_step', type=int, default=4000)
misc_arg.add_argument('--log_level', type=str, default='INFO', choices=['INFO', 'DEBUG', 'WARN'])
misc_arg.add_argument('--log_dir', type=str, default='logs')
misc_arg.add_argument('--data_dir', type=str, default='/Users/apple/Desktop/Penn2/CIS680/HW3/data/')
