...
data_arg.add_argument('--dataset', type=str, default='cufs', choices=['cufs', 'celeba'])
...
train_arg.add_argument('--max_step', type=int, default=400)
train_arg.add_argument('--img_save_step', type=int, default=40)
train_arg.add_argument('--epoch_step', type=int, default=20)
